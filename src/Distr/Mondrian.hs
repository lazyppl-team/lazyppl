...
datasetRelations = do
  rels' <- mh 1001 $ sample (sampleFiniteRelationFromMondrian2D paintingPietMondrian1921 20)
...
mhInference = do
  ...
  mws' <- mh 0.3 $ inferMondrian dataset uniform 4 [(0, 1), (0, 1)]
...
mh1Inference = do
  dataset <- datasetRelations
  mws' <- mh1 510000 $ inferMondrian dataset uniform 4 [(0, 1), (0, 1)]
